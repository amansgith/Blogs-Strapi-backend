export default [
  ...
  },
  {
    name: 'strapi::cors',
    config: {
      origin: ['https://trustwise-insurance-dgn684oai-amansgiths-projects.vercel.app/', 'https://trustwise-insurance-git-designtwo-amansgiths-projects.vercel.app/', 'http://localhost:3000'], // Add your Vercel domain here
